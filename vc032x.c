...
MODULE_PARM_DESC(force_sensor, "Force sensor model (0..9)");

static int force_bridge = -1;
module_param(force_bridge, int, 0644);
MODULE_PARM_DESC(force_bridge, "Force bridge model (0=VC0321, 1=VC0323)");
...
static const struct v4l2_pix_format vc0321_mode[] = {
	...
	{640, 480, V4L2_PIX_FMT_YUYV, V4L2_FIELD_NONE,
		...
		.colorspace = V4L2_COLORSPACE_SRGB,
		.priv = 0},
	{636, 476, V4L2_PIX_FMT_YUYV, V4L2_FIELD_NONE,
		.bytesperline = 636 * 2,
		.sizeimage = 636 * 476 * 2,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.priv = 0},
...
/*fixme: back sensor only*/
	...
	if (sd->bridge == BRIDGE_VC0321) {
		reg_w(gspca_dev, 0xa0, 0x19, 0xb003);
		reg_w(gspca_dev, 0xa0, 0x02, 0xb004);
...
static int sd_isoc_init(struct gspca_dev *gspca_dev)
{
	...
	if (!intf)
		return -ENODEV;
	/* Force Alt 7 (index 8 in 1-based gspca numbering) for maximum packet buffer */
